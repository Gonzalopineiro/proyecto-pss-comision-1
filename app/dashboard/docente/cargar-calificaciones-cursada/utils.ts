...
export function exportarAPDF(
  ...
  doc.text(`Docente: ${docenteInfo.nombre} ${docenteInfo.apellido}`, 20, 85);
  doc.text(`Email: ${docenteInfo.email}`, 20, 95);
  ...
  doc.text(`Sistema de Gestión Académica - ${docenteInfo.nombre} ${docenteInfo.apellido}`, 20, 292);
...
export function exportarAExcel(
  ...
  const csvContent = [
    ...
    [`Docente: ${docenteInfo.nombre} ${docenteInfo.apellido}`],
