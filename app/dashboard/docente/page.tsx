...
export default async function DocenteDashboard(){
  ...
  if (!session) redirect('/login?role=docente')
  if (session?.role !== 'docente') redirect(`/login?role=${session?.role ?? 'estudiante'}`)
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8">
          <div className="max-w-4xl bg-white dark:bg-slate-800 p-6 rounded-xl shadow">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300">Aquí gestionarás cursos, actas y estudiantes.</p>
