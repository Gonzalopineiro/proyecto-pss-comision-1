...
export default function PanelDocenteTemporal() {
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-6">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          ...
          <span className="block text-sm text-blue-600 dark:text-blue-400 mt-1">
            (Vista temporal en sección de alumno para testing)
          </span>
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
            ...
            <div className="p-6 space-y-3">
              <Link href="/dashboard/alumno/mesas-examen/crear-mesa">
            ...
            <div className="p-6">
              {mesas.length === 0 ? (
                ...
                <div className="space-y-3">
                  ...
                  {mesas.length > 4 && (
                    <Link href="/dashboard/alumno/mesas-examen">
