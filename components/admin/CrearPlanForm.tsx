              ...
              <div>
                  ...
                  <div className="flex gap-4">
                      <input 
                        ...
                        placeholder="5" 
                      />
                      <select className="flex-1 p-3 rounded-md border border-gray-300 bg-white text-gray-800 shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500">
                          <option>Años</option>
        ...
        <div className="border border-gray-200 rounded-lg p-6 mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-10 gap-x-6 gap-y-4 items-end">
                <div className="md:col-span-3">
                    ...
                    <select value={nombreNuevaMateria} onChange={e => setNombreNuevaMateria(e.target.value)} className="w-full p-3 rounded-md border border-gray-300 bg-white shadow-sm">
                ...
                <div className="md:col-span-2">
                    ...
                    <select value={cuatrimestreNuevaMateria} onChange={e => setCuatrimestreNuevaMateria(e.target.value)} className="w-full p-3 rounded-md border border-gray-300 bg-white shadow-sm">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {materiasAsociadas.map((m) => (
                            <tr key={m.materiaId}>
                                ...
                                <td className="px-6 py-4"><button onClick={() => handleQuitarMateria(m.materiaId)}><Trash2 className="h-5 w-5 text-gray-400 hover:text-red-600" /></button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
